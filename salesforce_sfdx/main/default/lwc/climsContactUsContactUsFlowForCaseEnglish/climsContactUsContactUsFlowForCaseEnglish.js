...
import { OMNIDEF } from './climsContactUsContactUsFlowForCaseEnglish_def.js';
import tmpl from './climsContactUsContactUsFlowForCaseEnglish.html';
import tmpl_nds from './climsContactUsContactUsFlowForCaseEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class climsContactUsContactUsFlowForCaseEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
