...
import { OMNIDEF } from './climsContactUsContactUsFlowForCaseFrench_def.js';
import tmpl from './climsContactUsContactUsFlowForCaseFrench.html';
import tmpl_nds from './climsContactUsContactUsFlowForCaseFrench_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class climsContactUsContactUsFlowForCaseFrench extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api layout;
    @api recordId;
